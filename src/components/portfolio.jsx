        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between gap-4 p-4">
          <div className="flex items-center gap-4">
            <FixedImage
              ...
              height="h-10"
              mode="cover"
              className="rounded-full overflow-hidden flex-shrink-0 border border-white/30 shadow-md"
            />
                ...
                <div className="flex items-start gap-4">
                  {c.img && (
                    <button
                      ...
                      type="button"
                    >
                      <FixedImage src={c.img} alt={c.title} width="w-32" height="h-20" mode="contain" className="rounded-md bg-white cursor-pointer hover:scale-105 transition-transform" />
                    </button>
                  )}
